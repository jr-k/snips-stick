...
class MiBand2(Peripheral):
    ...
    def button_forever_listener(self, button_callback):
        svc = self.getServiceByUUID(UUIDS.SERVICE_MIBAND1)
        char = svc.getCharacteristics(UUIDS.CHARACTERISTIC_DEVICEEVENT)[0]
        self.writeCharacteristic(char.getHandle() + 1, b"\x01\x00")
